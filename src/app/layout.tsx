...
export const metadata: Metadata = {
  ...
  description: 'wridachic (وريدة شيك) — Mode féminine marocaine : robes longues, ensembles modestes et essentiels. Livraison partout au Maroc, paiement à la livraison. Dès 299 MAD.',
  keywords: ['wridachic', 'wrida chic', 'وريدة شيك', 'mode marocaine', 'mode modeste', 'robes longues', 'jilbab', 'robes', 'caftan', 'mode femme Maroc', 'abaya', 'vêtements modestes', 'modest fashion'],
...
const ORG_JSONLD = {
  ...
  description: 'Mode féminine marocaine : robes longues, ensembles modestes et essentiels. Livraison partout au Maroc.',
